...
for k=1:max_step
        ...
        id_sensor(1,k)=id;
        [pair_id(k,:),low_inv_cond_id(1,k)]=best_pair(N,px,py,...
       ...
       [px(pair_id(k,1));px(pair_id(k,2))], [py(pair_id(k,1));py(pair_id(k,2))], [pair_id(k,1);pair_id(k,2)], k);
